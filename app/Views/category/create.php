...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form action="<?=base_url('kategori/store')?>" method="post" autocomplete="off" enctype="multipart/form-data">
            <?= csrf_field()?>
            <div class="form-group">
                <label for="kategori">Kategori</label>
                <input type="text" class="form-control" placeholder="Insert Kategori Name" name="category_name" required>
            </div>
