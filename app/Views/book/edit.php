        ...
        <form action="update" method="post" autocomplete="off" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="category" required>
                    ...
                    <?php if($book[0]->category_id == $category->category_id) : ?>
                    <option value="<?= $category->category_id ?>" selected="<?=$book[0]->category_id?>">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" rows="3" name="description" required><?=$book[0]->description?></textarea>
            </div>
            <div class="form-group">
                <label for="quantity">Quantity</label>
                <input type="number" class="form-control" placeholder="Input Quanity" name="quantity"
                    value="<?=$book[0]->quantity?>" required>
            </div>
            <div class="form-group">
                <label>Upload Cover Baru</label>
                <div class="custom-file">
                    <input type="file" name="cover_file" class="custom-file-input" id="cover_file" accept=".jpg, .png">
